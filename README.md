...
- [Venue Guest Playlist](./projects/venue-guests-song-requests.md)
- [ESP32-CAM Motion Detector](./projects/esp32-cam-motion-detector.md)
- [ESP32 Capacitive Screen](./projects/esp-capacitive-screen.md)
- [Subsurface Site Atlas (NETL POC)](./projects/netl-poc.md)
- [OurSquad — Coaching Workbench](./projects/OurSquad.md)
